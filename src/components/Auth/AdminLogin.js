...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call separate admin login endpoint
        ...
        <Col xs={12} sm={10} md={8} lg={6} xl={5}>
          <Card className="border-0 shadow-lg">
            <Card.Body className="p-4 p-md-5">
              <div className="text-center mb-4">
                ...
                <p className="text-muted">Access the administration dashboard</p>
              </div>
          ...
          {process.env.NODE_ENV === 'development' && (
            <Card className="border-0 shadow-sm mt-4">
              <Card.Body>
                <h6 className="mb-3">Demo Admin Credentials:</h6>
                <div className="small">
                  <p className="mb-1">
                    <strong>Email:</strong> admin@institute.edu
                  </p>
                  <p className="mb-1">
